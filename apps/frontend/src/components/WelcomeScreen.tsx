...
export default function WelcomeScreen({ isDarkMode, onToggleTheme, onSignIn, onSignUp, onGuestMode }: WelcomeScreenProps) {
            ...
            <div className="space-y-2.5">
              ...
              {onGuestMode && (
                <button
                  type="button"
                  onClick={onGuestMode}
                  className="w-full py-2.5 bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white font-semibold text-sm rounded-xl border border-slate-800 transition-all cursor-pointer"
                >
