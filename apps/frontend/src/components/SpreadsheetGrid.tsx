  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmModal
        ...
        onConfirm={() => { if (deleteConfirmId) deleteSpreadsheetRow(tab, deleteConfirmId); }}
        title="Delete Record"
                    ...
                    {({ index, style }) => {
                      ...
                      return (
                        <div
                          ...
                          style={{ ...style, gridTemplateColumns: `repeat(${columns.length}, minmax(150px, 1fr)) 100px` } as React.CSSProperties}
                          tabIndex={0}
                          onKeyDown={(e) => {
